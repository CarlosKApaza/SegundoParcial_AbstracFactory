...
#define UE_PROJECT_NAME SegundoParcial_PROO
#define UE_TARGET_NAME SegundoParcial_PROOEditor
#define UE_MODULE_NAME "SegundoParcial_PROO"
...
#define SEGUNDOPARCIAL_PROO_API DLLEXPORT
